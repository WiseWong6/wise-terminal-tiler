...
import Editor from '@/apps/mixed-preview/components/Editor';
import MixedPreview from '@/apps/mixed-preview/components/MixedPreview';
import AISettingsModal from '@/apps/mixed-preview/components/AISettingsModal';
import { useDebounce } from '@/apps/mixed-preview/hooks/useDebounce';
import {
  ...
  SAMPLE_MARKDOWN,
  SAMPLE_HTML,
} from '@/apps/mixed-preview/constants';
import type { AIConfig } from '@/apps/mixed-preview/types/ai-config';
import { loadAIConfig, saveAIConfig, fixCodeWithAI } from '@/apps/mixed-preview/services/ai-service';

export default function MixedPreviewApp() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-white text-slate-900">
      {/* Header */}
      <header className="flex items-center justify-end px-4 sm:px-6 py-3 bg-white border-b border-slate-200 shrink-0">
